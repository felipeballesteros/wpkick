			...
			jQuery(function($){
				...
				$.supersized({
					...
					<?php  if (have_posts()) : while (have_posts()) : the_post();
							get_portfolio_info ('sony-playstation', $post->ID, $thumbnum);
							endwhile; endif; ?>
...
<!-- Mobile and SEO Friendly Images
  ================================================== -->
<div class="wmuSlider <?php if( MultiPostThumbnails::get_the_post_thumbnail('sony-playstation', '2-slide', NULL,  'portfoliosmallnc') != '' ) { echo 'projectslideshow'; }?>">
