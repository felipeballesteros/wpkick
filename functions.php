...
function register_sortable($columns) {
	$columns['display_home'] = 'display_home';
	return $columns;
}

//allow sorting for the home display column
function column_orderby( $vars ) {
	if ( isset( $vars['orderby'] ) && 'display_home' == $vars['orderby'] ) {
		$vars = array_merge( $vars, array(
			'meta_key' => 'ag_home_page_display',
			'orderby' => 'meta_value'
		) );
	}
	return $vars;
...
function add_quick_home_edit($column_name, $post_type) {
	...
	<div class="inline-edit-col">
		...
		<div id="home_display_cont">
			<input type="radio" name="home_display" id="home_yes" value="Yes"/> Yes <br />
			<input type="radio" name="home_display" id="home_no" value="No" /> No
...
function get_home_value() {?>
   ...
   jQuery(document).on('click','a.editinline', function() {
		var home_display_value = inlineEditPost.getId(this),
